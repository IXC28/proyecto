...
const createNavSiLogin = () => {
  ...
  <div class="hidden lg:flex flex-row gap-2">
      ...
      <a href="/promos" class="text-black font-bold hover:text-#188196 py-2 px-2 rounded-lg transition ease-in-out">Promociones</a>
  ...
  <a href="/promos" class="text-black font-bold hover:text-#188196  py-2 px-2 rounded-lg transition ease-in-out border-gray-700/70 border-b-2">Promociones</a>
